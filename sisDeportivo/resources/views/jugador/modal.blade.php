...
<div class="row">
  <div class="col-md-9">
    ...
    <small class="modal-title" id="modal-register-label">
      Modificación de jugadores en el sistema</small>
    </div>
    <div class="col-md-3">
     ...
     <input type="hidden" name="_token" value="{{ csrf_token() }}">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-13 selectContainer">
          <select class="form-control-modal" name="horario" id="horario">
      ...
      <div class="form-group">
       {!! Form::select('numeros_id', array('default' => 'SELECCIONE NÚMERO DE JUGADOR') + $numeros,[ 'class' => 'form-control-modal'], array('id' => 'numeros_id')) !!}
     </div>
        ...
        <div class="alert alert-success alert-dismissible" style="display:none;" id="msjmodify" role="alert">  
          <p class="text-center">Jugador modificado satisfactoriamente</p>
        </div>
        <div class="alert alert-danger alert-dismissible" style="display:none;" id="msjnomodify" role="alert">  
          <p class="text-center">Email del jugador ya se encuentra registrado o debe escoger el número de jugador</p>
        </div> 
        @overwrite 
        @section('footer')
      ...
      $('#modification-form').bootstrapValidator("resetForm",true); 
        ...
        $(document).ready(function () {
          ...
          validator.on("success.form.bv", function (e) {
            ...
            var jornada = $('#horario').val();
            console.log(horario);
            var numero = $("#numeros_id").val();
            var token = $("#token").val();
            ...
            $.ajax({
              ...
              data: { identificacion,correo,jornada,numero},
